...
class treePredictor():
    ...
    def toggle_play_mode(self):
        self.playrand = not self.playrand  # Переключение режима между случайным выбором и предсказанием
    ...
    def predict(self):
        ...
        if self.playrand:  # Если режим случайного выбора активен
            ret = self.choices[randint(0, 2)]  # Просто выбираем случайный ход
            self.prevmove = ret
            return ret
