...
class RockPaperScissorsGame(QMainWindow):
    ...
    def initUI(self):
        ...
        self.setWindowIcon(QIcon('D:\Project\RPS\pic\RPS.png'))
        ...
        start_button.setStyleSheet(("color: rgb(4, 209, 86); background: rgb(56, 69, 48);"))
        ...
        self.music_button.setFixedSize(120, 70)
        self.music_button.setCheckable(True)
        self.music_button.setChecked(True)
        self.music_button.clicked.connect(self.toggle_music)
        self.music_button.setIcon(QIcon("pic/music_icon2.png"))
        self.music_button.setStyleSheet('background: transparent;')
    ...
    def toggle_music(self):
        if self.music_button.isChecked():
            ...
            self.player.pause()
            self.music_button.setIcon(QIcon("pic/music_icon.png"))
...
class RockPaperScissorsWidget(QWidget):
    ...
    def initUI(self):
        ...
        rock_button.setStyleSheet("color: rgb(83, 35, 145); font-size: 18px; background: rgb(136, 117, 189);")
        ...
        scissors_button.setStyleSheet("color: rgb(83, 35, 145); font-size: 18px; background: rgb(136, 117, 189);")
        ...
        paper_button.setStyleSheet("color: rgb(83, 35, 145); font-size: 18px; background: rgb(136, 117, 189);")
